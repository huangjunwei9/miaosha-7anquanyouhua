...
public class CodeMsg {
    ...
    public static CodeMsg MIAO_SHA_VERICODE_IMAGE = new CodeMsg(500582, "验证码错误！");
    public static CodeMsg MIAO_SHA_IMAGE = new CodeMsg(500581, "生成图片异常！");
    public static CodeMsg MIAO_SHA_ACCESS_LIMIT = new CodeMsg(500583, "一定时间内只允许访问有限的次数（5次）！");
