...
//        sender.send("hello,Junwei Huang");
//        return new Result("hello,Junwei Huang");
//    }
//
//    @RequestMapping("/mq/topic")
//    @ResponseBody
//    public Result<String> mqTopic(){
//        sender.sendTopic("hello, Junwei Huang, Topic");
//        return new Result("hello, Junwei Huang, Topic");
//    }
//
//    @RequestMapping("/mq/fanout")
//    @ResponseBody
//    public Result<String> mqFanout(){
//        sender.sendFanout("hello, Junwei Huang, Fanout");
//        return new Result("hello, Junwei Huang, Fanout");
//    }
//
//    @RequestMapping("/mq/headers")
//    @ResponseBody
//    public Result<String> mqHeaders(){
//        sender.sendHeaders("hello, Junwei Huang, Headers");
//        return new Result("hello, Junwei Huang, Headers");
//    }
