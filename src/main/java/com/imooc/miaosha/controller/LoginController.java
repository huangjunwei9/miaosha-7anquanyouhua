...
//    @RequestMapping("/do_login")
//    @ResponseBody
//    public Result<String> doLoginJSR303Yace(HttpServletResponse httpServletResponse, @Valid LoginVo loginVo){//@Valid去验证loginVo是否符合要求
//        log.info(loginVo.toString());
//
//        //输入验证正确，下一步：登录验证
//        String token = miaoshaUserService.loginYace(httpServletResponse, loginVo);
